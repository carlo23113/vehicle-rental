<template>
  <div class="dashboard-page">
    <CommonPageContainer>
      ...
      <!-- Statistics Cards -->
      <LazyDashboardStatsStatisticsCards :stats="stats" class="mb-6" />
      ...
      <v-row>
        <!-- Recent Rentals -->
        <v-col cols="12" lg="8">
          <LazyDashboardRentalsRecentRentalsTable :rentals="recentRentals" />
        </v-col>

        <!-- Quick Actions & Alerts -->
        <v-col cols="12" lg="4">
          <LazyDashboardQuickActions :actions="quickActions" @action-click="handleQuickAction" />
          <LazyDashboardAlertsMaintenanceAlerts :alerts="maintenanceAlerts" />
        </v-col>
      </v-row>
    </CommonPageContainer>
  </div>
