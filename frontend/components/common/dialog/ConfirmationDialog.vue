    ...
    <v-card class="rounded-2xl overflow-hidden">
      <v-card-text class="!p-0">
        ...
        <div class="icon-section pt-10 px-8 pb-8 flex justify-center">
          <div
            class="relative inline-flex items-center justify-center animate-[fadeInScale_0.3s_cubic-bezier(0.34,1.56,0.64,1)]"
          >
            <div
        ...
        <div class="!px-8 !pb-6 animate-[fadeInUp_0.4s_cubic-bezier(0.34,1.56,0.64,1)_0.1s_both]">
          ...
          <div
            v-if="hasItemInfo"
            class="item-info group my-5 mx-auto py-4 px-5 flex items-center gap-[14px] border-[1.5px] rounded-[14px] max-w-[340px] relative overflow-hidden transition-all duration-[250ms] ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-px hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)]"
          >
            <div
              v-if="icon"
              class="item-icon w-10 h-10 rounded-[10px] flex items-center justify-center flex-shrink-0 transition-all duration-[250ms] group-hover:scale-105"
            >
            ...
            <div class="flex-1 min-w-0">
              <div
                v-if="itemName"
                class="item-name text-[0.9375rem] font-semibold mb-0.5 tracking-[-0.01em] leading-[1.4]"
              >
                {{ itemName }}
              </div>
              <div
                v-if="itemDetails"
                class="item-meta text-[0.8125rem] font-medium tracking-[0.01em] leading-[1.3]"
              >
                {{ itemDetails }}
              </div>
            </div>
